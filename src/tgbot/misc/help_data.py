...
Внимательно проверьте, чтобы Ваша анкета имела соответствующий вид, не содержала ненормативной лексики и имела правильный вид.
Это необходимо для того, чтобы все рекламные сообщения имели общий вид. Если Вы допустите ошибки при формировании анкеты, то модератор отправит её обратно на редактирование
